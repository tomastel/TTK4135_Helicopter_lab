...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)(&helicopter1_B.TravelCounttorad), 0, 0, 31 }
  ,
  ...
  { (char_T *)(&helicopter1_DW.FromWorkspace_PWORK.TimePtr), 11, 0, 14 },

  { (char_T *)(&helicopter1_DW.HILInitialize_ClockModes[0]), 6, 0, 46 },

  { (char_T *)(&helicopter1_DW.HILInitialize_POSortedChans[0]), 7, 0, 8 },

  { (char_T *)(&helicopter1_DW.FromWorkspace_IWORK.PrevIndex), 10, 0, 2 },
...
static DataTypeTransition rtPTransitions[] = {
  ...
  { (char_T *)(&helicopter1_P.HILInitialize_OOTerminate), 0, 0, 49 },
