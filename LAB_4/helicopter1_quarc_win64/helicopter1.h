...
typedef struct {
  ...
  real_T TmpSignalConversionAtToFileInpo[8];
...
struct P_helicopter1_T_ {
  ...
  real_T Gain_Gain_lv;                 /* Expression: 180/pi
                                        ...
                                        */
  real_T elavationoffsetdeg_Value;     /* Expression: -30
                                        * Referenced by: '<Root>/elavation offset [deg]'
                                        */
 ...
 * '<S3>'   : 'helicopter1/Degrees to Radians1'
 * '<S4>'   : 'helicopter1/Elevation controller'
 * '<S5>'   : 'helicopter1/Helicopter_interface'
